...
const Form = ({ onFormSubmit, isLoading, email, isSuccess, onFormChange, password, passwordShown, togglePasswordVisiblity, onLoginWithGoogle }) => {
    return (
        <div className="col-lg-6 order-1">
            <div className="p-4 p-sm-7 p-xl-6">
                ...
                <p className="mb-0">
                    Belum punya akun?<Link to="/register" style={{ color: "#5143d9 " }}> Daftar di sini</Link>
                </p>
