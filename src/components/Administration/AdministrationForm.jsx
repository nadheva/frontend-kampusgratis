...
import { sendAdministrationBiodata, reset, resetState, sendAdministrationFamilial, sendAdministrationFiles, sendAdministrationDegree } from '../../features/administration/administrationSlice';
...
const AdministrationForm = () => {
  ...
  const [administrationBiodata, setAdministrationBiodata] = useState({
    full_name: "", nin: "", nin_address: "", email: "", residence_address: "", phone: "", study_program: "", semester: "",
    birth_place: "", birth_date: "", university_of_origin: "", gender: "", nsn: ""
  });
  ...
  return <>
    <div className="accordion accordion-icon accordion-bg-light" id="accordionExample">
      {isLoading && !isLoaded ? <span className="d-block bg-light text-center py-1 mt-1 mb-3 border">
              ...
              <form onSubmit={onFormSubmitBiodata}>
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <input type="text" className="form-control mb-3" name="full_name" value={full_name} placeholder="Nama Lengkap" onChange={onFormChangeAdministrationBiodata} />
                  </div>
                  <div className="col-md-6">
                    <label className="form-label"><span className='text-danger'><sup>*</sup></span> NIK</label>
                    <input type="text" className="form-control mb-3" name="nin" value={nin} placeholder="NIK" onChange={onFormChangeAdministrationBiodata} />
                  </div>
                  <div className="col-md-6">
                    <label className="form-label"><span className='text-danger'><sup>*</sup></span> Alamat Email</label>
                    <input type="text" className="form-control mb-3" name="email" value={email} placeholder="Alamat Email" onChange={onFormChangeAdministrationBiodata} />
                  </div>
                  <div className="col-md-6">
                    <label className="form-label"><span className='text-danger'><sup>*</sup></span> Program Studi</label>
                    <input type="text" className="form-control mb-3" name="study_program" value={study_program} placeholder="Program Studi" onChange={onFormChangeAdministrationBiodata} />
                  </div>
                  <div className="col-md-6">
                    <label className="form-label"><span className='text-danger'><sup>*</sup></span> Semester</label>
                    <input type="text" className="form-control mb-3" name="semester" value={semester} placeholder="Semester" onChange={onFormChangeAdministrationBiodata} />
                  </div>
                  <div className="col-md-6">
                    <label className="form-label"><span className='text-danger'><sup>*</sup></span> Alamat Lengkap</label>
                    <input type="text" className="form-control mb-3" name="nin_address" value={nin_address} placeholder="Alamat Lengkap" onChange={onFormChangeAdministrationBiodata} />
                  </div>
                  <div className="col-md-6">
                    <label className="form-label"><span className='text-danger'><sup>*</sup></span> Alamat Domisili</label>
                    <input type="text" className="form-control mb-3" name="residence_address" value={residence_address} placeholder="Alamat Domisili" onChange={onFormChangeAdministrationBiodata} />
                  </div>
                  <div className="col-md-6">
                    <label className="form-label"><span className='text-danger'><sup>*</sup></span> Tempat Lahir</label>
                    <input type="text" className="form-control mb-3" name="birth_place" value={birth_place} placeholder="Tempat Lahir" onChange={onFormChangeAdministrationBiodata} />
                  </div>
                  <div className="col-md-6">
                    <label className="form-label"><span className='text-danger'><sup>*</sup></span> Tanggal Lahir</label>
                    <input type="date" className="form-control mb-3" name="birth_date" value={birth_date} placeholder="dd/mm/yy" onChange={onFormChangeAdministrationBiodata} />
                  </div>
                  <div className="col-md-6">
                    <label className="form-label"><span className='text-danger'><sup>*</sup></span> Jenis Kelamin</label>
                    <select className="form-select" onChange={onFormChangeAdministrationBiodata} name="gender" value={gender}>
                  ...
                  <div className="col-md-6">
                    ...
                    <input type="text" className="form-control mb-3" name="phone" value={phone} placeholder="Nomor Handphone" onChange={onFormChangeAdministrationBiodata} />
                  </div>
                  <div className="col-md-6">
                    <label className="form-label"><span className='text-danger'><sup>*</sup></span> Universitas Asal</label>
                    <input type="text" className="form-control mb-3" name="university_of_origin" value={university_of_origin} placeholder="Universitas Asal" onChange={onFormChangeAdministrationBiodata} />
                  </div>
                  <div className="col-md-6">
                    <label className="form-label"><span className='text-danger'><sup>*</sup></span> NIM atau NPM</label>
                    <input type="text" className="form-control mb-3" name="nsn" value={nsn} placeholder="NIM atau NPM" onChange={onFormChangeAdministrationBiodata} />
                  </div>
                </div>
              ...
              <form onSubmit={onFormSubmitFamilial}>
                <div className="row">
                  <div className="col-md-6">
                    ...
                    <input type="text" className="form-control mb-3" name="father_name" value={father_name} placeholder="Nama Ayah" onChange={onFormChangeAdministrationFamilial} />
                  </div>
                  <div className="col-md-6">
                    <label className="form-label"><span className='text-danger'><sup>*</sup></span> Pekerjaan Ayah</label>
                    <input type="text" className="form-control mb-3" name="father_occupation" value={father_occupation} placeholder="Pekerjaan Ayah" onChange={onFormChangeAdministrationFamilial} />
                  </div>
                  <div className="col-md-6">
                    <label className="form-label"><span className='text-danger'><sup>*</sup></span> Penghasilan Ayah Perbulan</label>
                    <input type="text" className="form-control mb-3" name="father_income" value={father_income} placeholder="Pekerjaan Ayah" onChange={onFormChangeAdministrationFamilial} />
                  </div>
                  <div className="col-md-6">
                    <label className="form-label"><span className='text-danger'><sup>*</sup></span> Nama Ibu</label>
                    <input type="text" className="form-control mb-3" name="mother_name" value={mother_name} placeholder="Nama Ibu" onChange={onFormChangeAdministrationFamilial} />
                  </div>
                  <div className="col-md-6">
                    <label className="form-label"><span className='text-danger'><sup>*</sup></span> Pekerjaan Ibu</label>
                    <input type="text" className="form-control mb-3" name="mother_occupation" value={mother_occupation} placeholder="Pekerjaan Ibu" onChange={onFormChangeAdministrationFamilial} />
                  </div>
                  <div className="col-md-6">
                    <label className="form-label"><span className='text-danger'><sup>*</sup></span> Penghasilan Ibu Perbulan</label>
                    <input type="text" className="form-control mb-3" name="mother_income" value={mother_income} placeholder="Penghasilan Ibu Perbulan" onChange={onFormChangeAdministrationFamilial} />
                  </div>
                  <div className="col-md-6">
                    <label className="form-label"><span className='text-danger'><sup>*</sup></span> Pekerjaan Sendiri</label>
                    <input type="text" className="form-control mb-3" name="occupation" value={occupation} placeholder="Pekerjaan Sendiri" onChange={onFormChangeAdministrationFamilial} />
                  </div>
                  <div className="col-md-6">
                    <label className="form-label"><span className='text-danger'><sup>*</sup></span> Penghasilan Sendiri</label>
                    <input type="text" className="form-control mb-3" name="income" value={income} placeholder="Penghasilan Sendiri" onChange={onFormChangeAdministrationFamilial} />
                  </div>
                  <div className="col-md-6">
                    <label className="form-label"><span className='text-danger'><sup>*</sup></span> Tinggal Dengan</label>
                    <input type="text" className="form-control mb-3" name="living_partner" value={living_partner} placeholder="Tinggal Dengan" onChange={onFormChangeAdministrationFamilial} />
                  </div>
                  <div className="col-md-6">
                    <label className="form-label"><span className='text-danger'><sup>*</sup></span> Biaya Kuliah Ditanggung Oleh</label>
                    <input type="text" className="form-control mb-3" name="financier" value={financier} placeholder="Biaya Kuliah Ditanggung Oleh" onChange={onFormChangeAdministrationFamilial} />
                  </div>
                </div>
                <div className="d-sm-flex justify-content-end mt-2">
      ...
      {isLoading && !isLoaded ? <span className="d-block bg-light text-center py-1 mt-2 mb-3 border">
        <div className="spinner-border">
          <span className='visually-hidden'>Loading...</span>
        </div>
      </span> : <>
