									...
									<form onSubmit={onFormSubmitFiles}>
										<div className="row">
											...
											<div className="col-12">
												...
												{photo && (
													<div className="bg-light mb-3 p-3">{photo}</div>
												)}
												<div className="input-group mb-3">
													<input
														name="photo"
											...
											<div className="col-12">
												...
												{nin_card && (
													<div className="bg-light mb-3 p-3">{nin_card}</div>
												)}
												<div className="input-group mb-3">
													<input
														name="nin_card"
											...
											<div className="col-12">
												...
												{family_card && (
													<div className="bg-light mb-3 p-3">{family_card}</div>
												)}
												<div className="input-group mb-3">
													<input
														name="family_card"
											...
											<div className="col-12">
												...
												{certificate && (
													<div className="bg-light mb-3 p-3">{certificate}</div>
												)}
												<div className="input-group mb-3">
													<input
														name="certificate"
											...
											<div className="col-12">
												...
												{transcript && (
													<div className="bg-light mb-3 p-3">{transcript}</div>
												)}
												<div className="input-group mb-3">
													<input
														name="transcript"
