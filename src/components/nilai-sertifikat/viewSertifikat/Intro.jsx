...
const Intro = () => {
    return (
        <section className="bg-light">
            <div className="container pt-2 mt-0 mt-lg-5">
                <div className="row position-relative mb-0 mb-sm-5 pb-0 pb-lg-5">
                    <div className="col-lg-8 text-center mx-auto position-relative">
                        ...
                        <h1>Sertifikat Digital Kampus Gratis</h1>
                        <p className="pb-5">
                            Sertifikat ini adalah dokumen resmi dan valid dirilis oleh Kampus Gratis
                        </p>
                    </div>
                </div>
            </div>
