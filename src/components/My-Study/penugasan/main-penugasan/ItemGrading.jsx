...
const ItemGrading = ({ grading }) => {
    return (
        <Link to={`/studi-ku/${grading.subject_id}/pertemuan/${grading.session_id}/penugasan`} className="text-body">
            <div className="card border-start border-info border-4 shadow-lg rounded-2 px-4 py-2 my-4">
                <div className="d-flex justify-content-between align-items-center">
                    ...
                    <div className="d-flex flex-column align-items-center">
                        ...
                        <p className="m-0 text-info small">{grading?.status}</p>
