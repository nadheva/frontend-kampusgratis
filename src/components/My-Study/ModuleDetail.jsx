			...
			<div className="col-lg-12 col-xl-12 mb-4">
				<div className="card shadow p-2">
					<div className="card-body">
						...
						<p className="text-truncate-2 mb-3">{module.description}</p>
						<div className="d-sm-flex align-items-center">
							...
							>
								...
								{module.content_length.number_of_video} Video
								<span className="mx-3">|</span>
								<i className="fas fa-solid fa-file me-2"></i>{" "}
								{module.content_length.number_of_document} Dokumen
							</Link>
						</div>
					</div>
				</div>
