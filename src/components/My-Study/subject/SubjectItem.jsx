		...
		<div className="col-lg-4 col-md-6 col-sm-12">
			<div className="card shadow h-100">
				<Link to={subject.Subject.id}>
					<img src={subject.Subject.thumbnail_link} className="card-img-top" style={{ height: "210px", objectFit: "cover" }} alt={subject.Subject.name} />
				</Link>
				<div className="card-body pb-0">
					...
					<p className="mb-0 text-truncate-2">
						{subject?.Subject?.indicator ? <>
							{subject.Subject.indicator.trim().charAt(0).toUpperCase() + subject.Subject.indicator.trim().slice(1)}
						</> : <>
							...
						</>}
					</p>
