		...
		<>
			<div className="col-lg-12">
				<div className="row mb-4 align-items-center">
					...
					<div className="col-lg-4 d-flex justify-content-between align-items-center mt-3 mt-xl-0">
						{results.length !== 0 && isPageLoad && (
							<>
								<p className="mb-0 text-end">
									Memunculkan {results.length} dari{" "}
									{data?.subjects?.total_subject} Mata Kuliah
								</p>
							</>
						)}
					</div>
								...
								<>
									<div className="col-md-12">
										<div className="alert alert-info">
											Kamu belum mengambil mata kuliah atau mata kuliah tidak
											ditemukan.
										</div>
									</div>
								</>
						...
						<ul className="pagination pagination-primary-soft d-inline-block d-md-flex rounded mb-0">
							{isPageLoad && (
								<>
									...
									{renderPage()}
									{currentPage !== lastPage && lastPage > 2 && (
										<li className="page-item mb-0">
											<button
												className="page-link"
