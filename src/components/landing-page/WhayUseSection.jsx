  ...
  const data = [
    {
      ...
      title: "Belajar dengan Experts",
      deskripsi: "Dibimbing langsung oleh ahli dibidangnya yang membantu dalam proses belajar.",
    },
    {
      id: 2,
      ...
      deskripsi: "Kamu akan mendapat sertifikat kelulusan resmi yang bisa digunakan untuk mempermudah mendapatkan pekerjaan.",
    },
    {
      id: 3,
      ...
      deskripsi: "Memberikan pembelajar dengan pilihan tentang di mana, kapan, dan bagaimana pembelajaran terjadi, dengan menggunakan berbagai teknologi.",
    },
    {
      id: 4,
      ...
      deskripsi: "Dibimbing untuk membuat CV dan portofolio, personal branding, persiapan wawancara, hingga koneksi kerja di startup bergengsi.",
    },
  ]
