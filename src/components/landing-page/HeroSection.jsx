                ...
                <div className="row align-items-center g-5">
                    <div
                        ...
                        <figure className="fill-warning position-absolute bottom-0 end-0 me-5 d-none d-xl-block">
                            <svg width="42px" height="42px" className="">
                        ...
                        <div className="d-sm-flex align-items-center justify-content-center justify-content-lg-start">
                            <Link to="/register" className="btn btn-lg btn-danger-soft me-2 mb-4 mb-sm-0">
                    ...
                    <div className="col-lg-7 col-xl-6 text-center position-relative animate-move-x  " data-aos="fade-left"
                    >
                        ...
                        <figure className="position-absolute top-50 start-50 translate-middle mt-n7 ">
                            <svg className="fill-warning animate-move-y">
                        ...
                        <div className=" position-absolute top-50 start-0 translate-middle-y mt-n7 d-none d-sm-block">
                        ...
                        <div className="position-absolute top-0 end-0 me-5">
                            <div className="p-2 bg-white shadow rounded-3">
                                <img src="assets/images/client/angular.svg" alt="Icon" />
                            </div>
                        </div>
                        <div className="position-absolute top-50 end-0 translate-middle-y mt-5 ms-5 d-none d-lg-block z-index-9">
                            <div className="p-2 bg-white shadow rounded-3 ">
                        ...
                        <div
                            className="d-inline-block  position-absolute top-50 end-0 translate-middle-y mt-n7 z-index-1 d-none d-md-block"
                        >
                            <div className="p-3 bg-success rounded-4 shadow-lg"
                                style={{
                                    background:
