		...
		<section className="position-relative overflow-hidden pt-5 pt-lg-3">
			...
			<div className="container">
				<div className="row align-items-center g-5">
					...
					>
						...
						<ul className="list-group position-relative justify-content-center justify-content-lg-start mb-4">
							...
							<li className="list-group-item border-0 me-2">
								<i className="bi bi-patch-check-fill h6 me-1" />
								Belajar Dengan Para Experts
							</li>
							<li className="list-group-item border-0 me-2">
								<i className="bi bi-patch-check-fill h6 me-1" />
								Mendapatan Sertifikat
							</li>
						</ul>
					...
					<div
						className="col-lg-7 col-xl-6 text-center position-relative animate-move-x  "
						data-aos="fade-left"
					>
						...
						<div className="d-inline-block  position-absolute top-50 end-0 translate-middle-y mt-n7 z-index-1 d-none d-md-block">
							<div
								className="p-3 bg-success rounded-4 shadow-lg"
								style={{
									background:
						...
						<div className="position-relative">
							...
							<img
								src="./assets/images/asset-kg/romario.png"
								alt=""
								style={{ height: "600px" }}
							/>
						</div>
