...
const getMySubjects = async (currentPage, search) => {
	...
	const response = await axios.get(
		API_URL +
			`subject/enrolledsubjects?page=${currentPage}&limit=6&search=${search}`,
		config
	);
...
const getQuizBySession = async (sessionId) => {
	...
	const response = await axios.get(
		API_URL + `quiz/desc/session/${sessionId}`,
		config
	);
...
const getQuestions = async (materialId) => {
	...
	const response = await axios.get(
		API_URL + `quiz/continue/${materialId}`,
		config
	);
...
const getSessions = async (subjectId) => {
	...
	const response = await axios.get(
		API_URL + `session/getfromsub/${subjectId}`,
		config
	);
...
const getDiscussions = async (sessionId) => {
	...
	const response = await axios.get(
		API_URL + `forum/discussionforum/session/${sessionId}`,
		config
	);
...
const getModuleBySession = async (sessionId) => {
	...
	const response = await axios.get(
		API_URL + `module/session/${sessionId}`,
		config
	);
...
const getDocument = async (documentId) => {
	...
	const response = await axios.get(
		API_URL + `module/document/${documentId}`,
		config
	);
