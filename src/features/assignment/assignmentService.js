...
const getAssignments = async () => {
	...
	const response = await axios.get(
		API_URL + `assignment/submissiondata`,
		config
	);
...
const getAssignment = async (sessionId) => {
	...
	const response = await axios.get(
		API_URL + `assignment/session/${sessionId}`,
		config
	);
...
const sendAssignment = async (sessionId, assignment) => {
	...
	const response = await axios.post(
		API_URL + `assignment/submit/${sessionId}`,
		{
...
const updateAssignment = async (sessionId, assignment) => {
	...
	const response = await axios.put(
		API_URL + `assignment/edit/${sessionId}`,
		{
			file_assignment: assignment,
		},
		config
...
const deleteAssignment = async (sessionId) => {
	...
	const response = await axios.delete(
		API_URL + `assignment/delete/${sessionId}`,
		config
	);
