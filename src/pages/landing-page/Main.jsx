            ...
            <div class="bg-light p-4 p-sm-5 rounded-3 position-relative overflow-hidden">
              ...
              <div class="row g-4 justify-content-center align-items-center position-relative">
                ...
                <div class="col-lg-6 text-center">
                  <h3 class="mb-0 mt-2 mb-2">Tujuan pendidikan adalah mengganti pikiran kosong dengan pikiran terbuka.</h3>
                  <span class="h6 fw-light">- Malcolm Forbes</span>
                </div>
                <div class="col-lg-3 text-center text-lg-end z-index-9">
                  <a href="#" class="btn btn-warning mb-0">Get Started</a>
                </div>
              </div>
            </div>
          </div>
