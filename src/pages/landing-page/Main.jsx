				...
				<div className="container pt-5 mt-0 mt-lg-5">
					<div className="row position-relative mb-0 mb-sm-5 pb-0 pb-lg-5">
						<div className="col-lg-8 text-center mx-auto position-relative">
							...
							<h1>
								Pembelajaran <span className="text-success">Gratis</span> dan{" "}
								<span className="text-danger">Terpercaya</span> Pertama di
								Indonesia
							</h1>
							<p>
								Dapatkan inspirasi dan temukan sesuatu yang baru hari ini.
								Kembangkan keterampilan Anda kursus dan sertifikasi online
								paling berguna di bidang pemasaran, teknologi informasi,
					...
					<div className="row g-lg-5 mt-3">
						<div className="col-md-3 col-lg-3 text-center position-relative">
							...
							<div className="px-4">
								...
								<p className="text-truncate-2 pb-0">
									Vidio, Presentasi, Dokumen. Bisa digunakan di perangkat apa
									pun!
								</p>
							</div>
						</div>
						<div className="col-md-3 col-lg-3 text-center pt-0 pt-lg-5 position-relative">
							...
							<div className="px-4">
								...
								<p className="text-truncate-2 pb-0">
									Pembelajaran yang terstruktur membuat belajar menjadi lebih
									mudah dan cepat!
								</p>
							</div>
						</div>
						<div className="col-md-3 col-lg-3 text-center position-relative">
							...
							<div className="px-4">
								...
								<p className="text-truncate-2 pb-0">
									Uji kemampuan anda & lihat apa pendapat mereka tentang konten
									Kami.
								</p>
							</div>
						</div>
				...
				<div className="container">
					...
					<div className="row mb-4">
						<div className="col-12">
							...
							<p className="mb-0">
								Temukan kursus yang terbaik untuk profesi Anda
							</p>
						</div>
					</div>
				...
				<div className="container">
					...
					<div className="row mb-4">
						<div className="col-12">
							...
							<p className="mb-0">
								Ruang terbatas Bergabung secepatnya di Kampus Gratis!
							</p>
						</div>
					</div>
