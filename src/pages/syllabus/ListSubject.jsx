...
// 	const [isEligibleToTake, setIsEligibleToTake] = useState(false);
...
// 		if (data?.study_plan?.studentsInformation?.Majors) {
// 			setIsEligibleToTake(
// 				!data?.study_plan?.studentsInformation?.Majors.find(
// 					(major) => major.StudentMajor.major_id === data?.subjects?.major?.id
// 				)
// 			);
// 			setCurrentUserMajors(data?.study_plan?.studentsInformation?.Majors);
// 		}
...
// 																	<>
// 																		<div className="alert alert-info">
// 																			Kamu dapat mengambil Mata Kuliah pada
// 																			Jurusan ini.
// 																		</div>
// 																	</>
// 																) : (
