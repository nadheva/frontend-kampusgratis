		...
		<>
			...
			<main>
				...
				<section className="pt-0">
					<div className="container">
						<form
							className="bg-light border p-4 rounded-3 my-4 z-index-9 position-relative"
							onSubmit={doFilter}
						>
							<div className="row g-3">
								<div className="col-xl-11">
									<input
										...
										type="search"
										placeholder="Masukkan Rencana Studi yang ingin dicari ..."
												...
												!isLoadingAdministration && (
													<>
														{dataAdministration?.is_approved?.overall ? (
															<>
																{currentUserMajors.length >= 0 &&
																	currentUserMajors.length !== 2 && (
																		<>
																			<div className="col-12 ">
																				<div
																					...
																					role="alert"
																				>
																					Kamu dapat mengambil Rencana Studi dan
																					Mata Kuliah (KRS) dengan memilih
																					Rencana Studi di bawah ini.
																				</div>
																			</div>
																		</>
																	)}
															...
															<>
																<div className="col-12">
																	<div
																		...
																		role="alert"
																	>
																		Kamu tidak dapat mengambil Rencana Studi dan
																		Mata Kuliah (KRS) apabila kamu belum
																		melakukan administrasi. Klik{" "}
																		<Link to="/administrasi">di sini</Link>{" "}
