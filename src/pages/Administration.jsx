									...
									<div className="row">
										<div className="col-sm-6 d-flex align-items-center">
											...
											{data?.is_approved?.overall === true
												? <span className='badge bg-success bg-opacity-10 ms-3 text-dark py-2'>DITERIMA</span>
												: <span className="badge bg-primary bg-opacity-10 ms-3 text-primary py-2">MENUNGGU</span>}
										</div>
										{data?.is_approved?.overall === true
								...
								<div className="card-body mt-2">
									{data?.is_approved?.overall == false ? <>
										<div className="alert alert-info">
											Harap untuk tidak mengganti data atau file administrasi apabila sedang dalam status <strong>MENUNGGU</strong>, karena administrasi dilihat sesuai dengan antrian.
										</div>
									</> : null}
