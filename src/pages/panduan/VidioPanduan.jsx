					...
					<div className="container">
						<div className="row position-relative">
							<div className="col-lg-10 mx-auto text-center position-relative">
								<h1>Video Panduan</h1>
								<p>
									Video tutorial penggunaan dan fungsi fitur yang ada di website
									Kampus Gratis
								</p>
							</div>
							<div className="row position-relative">
							...
							<div className="col-sm-6 col-lg-4 col-xl-3">
								<div className="card bg-transparent">
									<div className="overflow-hidden rounded-3">
										...
										{/* Overlay */}
										<div className="bg-overlay bg-dark opacity-4" />
										<div className="card-img-overlay d-flex align-items-start p-3"></div>
									</div>
									{/* Card body */}
									<div className="card-body">
										{/* Title */}
										...
										<p className="text-truncate-2">
											...
											experts say. Yet remarkably appearance get him his
											projection.
										</p>
										{/* Info */}
										<div className="d-flex justify-content-between">
