                                ...
                                <div className="card bg-transparent">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <p className="text-truncate-2">
                                            ...
                                            Laughter proposal laughing any son law consider. Needed except up
                                            piqued an.
                                        </p>
                                        {/* Info */}
                                ...
                                <div className="card bg-transparent">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <p className="text-truncate-2">
                                            ...
                                            list down to colleges that best fit their needs, experts say. Yet
                            ...
                            <div className="col-sm-6 col-lg-4 col-xl-3">
                                <div className="card bg-transparent">
                                    ...
                                    <div className="card-body">
                                        {/* Title */}
                                        <h5 className="card-title">
                                            <a href="#">Best Pinterest Boards for learning about business</a>
                                        </h5>
                                        <p className="text-truncate-2">
                                            Fully taken by worse do. Points afraid but may end law. Points
                                            afraid but may end law.
                                        </p>
                                        {/* Info */}
                                        <div className="d-flex justify-content-between">
                                            <h6 className="mb-0">
